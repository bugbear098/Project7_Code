...
# === Parameters ===
DATA_DIR = "/Users/lukesalter/Library/CloudStorage/GoogleDrive-luke.salter111@gmail.com/My Drive/Machine_Learning/Project7_data/Data_Medium/Processed_Transformer_Chrono"
...
X_test, y_test = load_csvs(DATA_DIR, "test")
...
assert set(np.unique(y_test)).issubset({0,1}), f"Unexpected labels in y_test: {np.unique(y_test)}"
